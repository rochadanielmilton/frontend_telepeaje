<template>
  <q-page>
    <Titulo titulo="Recaudación Reten por Año" icono="business"></Titulo>
    <div class="col-xs-12">
        ...
        <q-toolbar inset class="q-gutter-md q-px-md q-pb-md">
          <div class="col-xs-12 col-md-12">
            <q-form class="row col-xs-12 col-md-12 q-col-gutter-md q-col-gutter-y-md" method="post" @submit="listaRecaudacion()">
              ...
              <div class="col-xs-2 col-md-1 " style="top: 10px">
              <q-btn icon="download" color="secondary" label="" class="col-xs-12 col-md-1" @click="exportar()">
...
export default {
  ...
  setup () {
    ...
    const url = ref('/transacciones/reportePorRegionalRetenAnual')
    ...
    const exportar = async () => {
      ...
      doc.autoTable({
        ...
        // Header
          ...
          doc.setFontSize(15)
          doc.text('REPORTE RETEN POR AÑO', data.settings.margin.left + 5, 1.6, 'center')
          doc.setFontSize(9)
