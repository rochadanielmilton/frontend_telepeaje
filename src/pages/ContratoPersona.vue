    ...
    ></Titulo>
        <q-card-section class="text-left">
            <q-btn
              ...
              color="primary"
              class="q-ml-sm"
              @click="$router.replace('/app/cuentapersona')"
            >
            <q-icon
              center
              name='reply'
...
export default {
  ...
  setup () {
    ...
    const url = ref('/empadronamiento/verContratoPersona')
    const urlRegistro = ref('/empadronamiento/registrarNuevoContratoPersona')
    ...
    const idPersona = _storage.get('idPersona')
    const openModal = async (open, id) => {
      resetForm()
      contratoRegistro.value.id_entidad_persona = idPersona
      const ultimoContrato = await _http.get(`${url.value}/${idPersona}`)
